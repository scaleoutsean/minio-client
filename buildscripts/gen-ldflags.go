...
func genLDFlags(version string) string {
	...
	ldflagsStr = "-s -w -X github.com/scaleoutsean/minio-client/cmd.Version=" + version + " "
	ldflagsStr = ldflagsStr + "-X github.com/scaleoutsean/minio-client/cmd.CopyrightYear=" + copyrightYear + " "
	ldflagsStr = ldflagsStr + "-X github.com/scaleoutsean/minio-client/cmd.ReleaseTag=" + releaseTag + " "
	ldflagsStr = ldflagsStr + "-X github.com/scaleoutsean/minio-client/cmd.CommitID=" + commitID() + " "
	ldflagsStr = ldflagsStr + "-X github.com/scaleoutsean/minio-client/cmd.ShortCommitID=" + commitID()[:12]
	return ldflagsStr
}
